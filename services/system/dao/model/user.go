...
type User struct {
	...
	InviteBy       uint      `json:"invite_by" gorm:"column:invite_by;type:int"`
	OwnerFarmNum   uint      `json:"owner_farm_num" gorm:"column:owner_farm_num;type:int"`
	OwnerMinerNum  uint      `json:"owner_miner_num" gorm:"column:owner_miner_num;type:int"`
}
